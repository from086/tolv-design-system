...
export default {
  ...
  render: renderButton,
  argTypes: {
    type: { control: 'inline-radio', options: ['Primary', 'Secondary', 'Tertiary', 'Quaternary', 'Caution'], description: '種別' },
...
export const Overview = {
  ...
  render: () => {
    const types = ['Primary', 'Secondary', 'Tertiary', 'Quaternary', 'Caution'];
    const states = [
